...
const SocialMediaButton: React.FC<SocialMediaButtonProps> = ({ url, children }) => {
  ...
  const buttonClass = `flex justify-center mx-2 px-4 py-2 text-base font-medium border border-transparent rounded-lg hover:border-indigo-600 cursor-pointer transition-colors duration-200 ${
