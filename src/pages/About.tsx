...
const skillGroups = [
  {
    ...
    items: [
      "Tenable Nessus", "Qualys", "OpenVAS", "CrowdStrike Falcon",
      "Suricata", "Zeek", "Elastic SIEM", "Kibana", "Wazuh",
      "Wireshark", "Burp Suite", "Ghidra", "Metasploit",
      "MITRE ATT&CK", "CIS Benchmarks", "NIST CSF",
    ],
  },
  {
    label: "Technologies",
    ...
    items: [
      "Intune", "Entra ID", "Active Directory", "Git", "Tailscale",
      "Zscaler", "Linux", "Proxmox", "TrueNAS SCALE", "Kubernetes",
      "Docker", "Nginx", "Caddy", "JUnit", "React.js", "Node.js", "Express.js",
    ],
  },
  {
    label: "Languages",
    ...
    items: [
      ...
      "HTML", "CSS", "Bash", "PowerShell", "C/C++", "x86 Assembly", "SQL",
    ],
  },
];

const apoRoles = [
  { role: "Service Committee Member", period: "Fall 2025 – Spring 2026", active: false },
      ...
      <div className="w-full mx-4 md:mx-0">
        <div className="flex flex-col items-center text-center mt-16">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center md:space-x-8 md:items-start px-4">
            ...
            >
              <p className="mb-4">
                I'm Sean Finch, from Orange County, California, and am pursuing a B.S. in Cybersecurity
                with a Music Minor at Northeastern University. I blend technical expertise with creative
                problem-solving to make a tangible impact in cybersecurity and IT.
              </p>
              <p className="mb-4">
                I'm currently a Systems Engineer Intern at Neuralink, where I'm helping build core
                security operations capabilities from the ground up. Current focus areas include endpoint
                security, access control for managed devices, Linux MDM adoption, Defender XDR rollout,
                early SIEM implementation, and creating a structured internal security knowledge base.
              </p>
              <p className="mb-4">
                Previously, I worked as an IT Operations Co-op (Security Operations) at Audax Group and
                as a Cybersecurity Intern at CENIC, supporting vulnerability management, endpoint
                hardening, and network defense workflows. I'm also an incoming Enterprise Security
                Engineer Intern at Palo Alto Networks.
              </p>
              <p className="mb-4">
                In my homelab, I run a virtualized environment with TrueNAS SCALE, experimenting with
                platforms and honing my skills in system administration and infrastructure optimization.
              </p>
              <p className="mb-4">
                Beyond tech, I'm deeply involved in music and service leadership. I served as Vice
                President of Northeastern University Choral Society (NUCS) in Spring 2025 and served as
                President from Fall 2025 through Spring 2026. In Alpha Phi Omega, I served on the Service
                Committee (Fall 2025 - Spring 2026), served as Standards Chair (Spring 2026), and will
                serve as President in Fall 2026. I'm also a vocalist and outdoor enthusiast.
              </p>

              <div className="mt-4">
                <h2 className="text-2xl font-bold mb-4 font-jost">Technical Skills</h2>
          ...
          <div className="w-full max-w-3xl mx-auto px-4 mb-2">
            <div className={`flex flex-wrap items-center gap-2 justify-center py-4 border-y
              ...
              {["Win XP", "Win 7", "Win 10/11", "Win Server 2012", "Win Server 2016",
                "Ubuntu", "Debian", "Linux Mint", "CentOS", "Fedora",
                "Proxmox VE", "TrueNAS SCALE", "macOS"].map(os => (
                <span
                  key={os}
            ...
            <div className="relative">
              ...
              <div className="relative pl-14 mb-10">
                ...
                <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1 mb-2">
                  <h3 className="text-xl font-bold font-jost">Alpha Phi Omega</h3>
                ...
                <p className="text-sm font-raleway text-muted-foreground mb-3">
                  National co-ed service fraternity — chapter leadership at Northeastern.
                </p>
                <div className="space-y-2">
                  {apoRoles.map(({ role, period, active }) => (
                    <div key={role} className="flex items-center gap-2 text-sm">
                      <span className="text-muted-foreground shrink-0">↳</span>
                      <span className={`font-monospace ${active ? "font-semibold" : "text-muted-foreground"}`}>{role}</span>
                      <span className="ml-auto text-xs font-monospace text-muted-foreground flex items-center gap-1.5 shrink-0">
                        {active && <span className="w-1.5 h-1.5 rounded-full bg-green-500 animate-pulse-dot inline-block" />}
                        {period}
                      </span>
                    </div>
                  ))}
              ...
              <div className="relative pl-14">
                ...
                <div className="flex flex-wrap items-baseline gap-x-3 gap-y-1 mb-2">
                  <h3 className="text-xl font-bold font-jost">NU Choral Society</h3>
                ...
                <p className="text-sm font-raleway text-muted-foreground mb-3">
                  Northeastern University Choral Society — vocal performance and leadership.
                </p>
                <div className="space-y-2">
                  {nucsRoles.map(({ role, period }) => (
                    <div key={role} className="flex items-center gap-2 text-sm">
                      <span className="text-muted-foreground shrink-0">↳</span>
                      <span className="font-monospace text-muted-foreground">{role}</span>
                      <span className="ml-auto text-xs font-monospace text-muted-foreground shrink-0">{period}</span>
                    </div>
                  ))}
                </div>
              </div>
